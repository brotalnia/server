...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MAX_FAKE_CHARACTERS,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_CREATURE_RAID_HP,
    ...
    CONFIG_FLOAT_RATE_CREATURE_RAID_DAMAGE,
    ...
    CONFIG_FLOAT_RATE_CREATURE_RAID_SPELLDAMAGE,
    ...
    CONFIG_FLOAT_RATE_HONOR_DISHONOR,
    CONFIG_FLOAT_RATE_HONOR_BATTLEGROUND,
    CONFIG_FLOAT_RATE_HONOR_WORLD,
