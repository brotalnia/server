...
SET v = (SELECT COUNT(*) FROM `migrations` WHERE `id`='20171122005349');
IF v=0 THEN
INSERT INTO `migrations` VALUES ('20171122005349');
-- Add your query below.

UPDATE `creature_template` SET `MechanicImmuneMask`=1011548672 WHERE `entry` IN 
